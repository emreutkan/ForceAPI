...
urlpatterns = [
    ...
    path('coach/next/', NextWorkoutCoachView.as_view(), name='next-workout-coach'),
    ...
    path('active/coach/', ActiveWorkoutCoachView.as_view(), name='active-workout-coach'),
    ...
    path('<int:workout_id>/coach-review/', CoachReviewView.as_view(), name='workout-coach-review'),
